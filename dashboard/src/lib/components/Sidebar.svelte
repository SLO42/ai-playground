<script lang="ts">
	...
	const navItems = [
		...
		{ href: '/templates', label: 'Templates', icon: 'M4 5a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm10 0a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1V5zM4 15a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1v-4zm10 0a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1v-4z' },
		...
		{ href: '/diagnostics', label: 'Diagnostics', icon: 'M11.42 15.17l-5.1 5.1a2.12 2.12 0 01-3-3l5.1-5.1m0 0L3 7.75V4h3.75l4.42 4.42m0 6.75l1.5-1.5M20.47 5.53a3.5 3.5 0 00-4.95 0l-1.77 1.77 4.95 4.95 1.77-1.77a3.5 3.5 0 000-4.95z' },
		...
		{ href: '/demo', label: 'Demo', icon: 'M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
