...
export function buildTaskPrompt(task: Task): string {
	...
	const parts = [
		...
		`5. Do NOT update documentation files — a follow-up documenter agent handles that`,
		``,
		`## Claude Flow (MCP Tools)`,
		`You have access to claude-flow MCP tools. Use them:`,
		`- **memory_search** — Search BEFORE starting. Another agent may have solved a similar problem.`,
		`- **memory_store** — Store patterns and solutions you discover for future agents.`,
