...
- **Decision brief** (Lane C format): one-sentence ask · completeness score from real panel rows · dual effort label (cost-to-apply / cost-of-wrongness) · 2–4 evidence links · **falsifier** (the strongest reason NOT to approve, sourced from panel pushback or the incumbent's record) · Approve / Reject / Defer.
